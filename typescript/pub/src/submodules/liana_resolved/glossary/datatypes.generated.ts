...
export namespace N {
    ...
    export namespace Temp_$_$Type_$_$Selection_$_$Tail {
                                                                        ...
                                                                        export namespace N {
                                                                            ...
                                                                            export namespace G {
                                                                                ...
                                                                                export namespace N {
                                                                                    ...
                                                                                    export namespace referencee_$_$type {
...
export namespace T {
    ...
    export namespace Atom {
        ...
        export namespace _ltype {
            ...
            export namespace constraint {
                ...
                export type O<GAnnotation> = T.Labels.atom__types.D<GAnnotation>
            }
            
            export type constraint<GAnnotation> = [ false ] | [ true, T.Labels.atom__types.D<GAnnotation>]
    ...
    export namespace Global__Type__Selection {
        ...
        export namespace _ltype {
            ...
            export namespace constraint {
                ...
                export type O<GAnnotation> = T.Type__Library.global__types.definitions.D<GAnnotation>
            }
            
            export type constraint<GAnnotation> = [ false ] | [ true, T.Type__Library.global__types.definitions.D<GAnnotation>]
        ...
        export type _ltype<GAnnotation> = {
            readonly 'annotation': GAnnotation
            readonly 'constraint': [ false ] | [ true, T.Type__Library.global__types.definitions.D<GAnnotation>]
            readonly 'key': string
        }
    }
    ...
    export namespace Lookup__Selection {
        ...
        export namespace parameter {
            ...
            export type constraint<GAnnotation> = [ false ] | [ true, T.Parameters.D<GAnnotation>]
        ...
        export type parameter<GAnnotation> = {
            readonly 'annotation': GAnnotation
            readonly 'constraint': [ false ] | [ true, T.Parameters.D<GAnnotation>]
            readonly 'key': string
        }
    ...
    export namespace Temp__Type__Selection {
        ...
        export type global__type<GAnnotation> = T.Global__Type__Selection<GAnnotation>
                ...
                export namespace array {
                    ...
                    export namespace constraints {
                        ...
                        export namespace array {
                            ...
                            export type O<GAnnotation> = T.Type._ltype.array<GAnnotation>
                        }
                        
                        export type array<GAnnotation> = [ false ] | [ true, T.Type._ltype.array<GAnnotation>]
                    }
                    
                    export type constraints<GAnnotation> = {
                        readonly 'array': [ false ] | [ true, T.Type._ltype.array<GAnnotation>]
                    }
                ...
                export namespace tagged__union {
                    ...
                    export namespace constraints {
                        ...
                        export namespace tagged__union {
                            ...
                            export type O<GAnnotation> = T.Type._ltype.tagged__union<GAnnotation>
                        }
                        
                        export type tagged__union<GAnnotation> = [ false ] | [ true, T.Type._ltype.tagged__union<GAnnotation>]
                    }
                    
                    export type constraints<GAnnotation> = {
                        readonly 'tagged union': [ false ] | [ true, T.Type._ltype.tagged__union<GAnnotation>]
                    }
    ...
    export namespace Type {
        ...
        export type classes<GAnnotation> = pt.Dictionary<null>
        ...
        export namespace _ltype {
            ...
            export namespace group {
                ...
                export type properties<GAnnotation> = T.Properties<GAnnotation>
            }
            
            export type group<GAnnotation> = {
                readonly 'properties': T.Properties<GAnnotation>
            }
            ...
            export namespace terminal {
                ...
                export type terminal<GAnnotation> = T.Atom<GAnnotation>
            }
    ...
    export namespace Type__Library {
        ...
        export namespace global__types {
            ...
            export type declarations<GAnnotation> = pt.Dictionary<T.Global__Type__Declaration<GAnnotation>>
            
            export namespace definitions {
                
                export type D<GAnnotation> = T.Global__Type__Definition<GAnnotation>
            }
            
            export type definitions<GAnnotation> = pt.Dictionary<T.Global__Type__Definition<GAnnotation>>
        }
        
        export type global__types<GAnnotation> = {
            readonly 'declarations': pt.Dictionary<T.Global__Type__Declaration<GAnnotation>>
            readonly 'definitions': pt.Dictionary<T.Global__Type__Definition<GAnnotation>>
        }
        
        export type imports<GAnnotation> = T.Imports<GAnnotation>
        
        export type labels<GAnnotation> = T.Labels<GAnnotation>
    }
    ...
    export type Type__Library<GAnnotation> = {
        ...
        readonly 'labels': T.Labels<GAnnotation>
    }
    ...
    export namespace Value__Selection__Tail {
        ...
        export namespace content {
                    ...
                    export namespace reference {
                        ...
                        export namespace constraints {
                            ...
                            export namespace reference {
                                ...
                                export type O<GAnnotation> = T.Type._ltype.terminal<GAnnotation>
                            }
                            
                            export type reference<GAnnotation> = [ false ] | [ true, T.Type._ltype.terminal<GAnnotation>]
                        }
                        
                        export type constraints<GAnnotation> = {
                            readonly 'reference': [ false ] | [ true, T.Type._ltype.terminal<GAnnotation>]
                        }
            ...
            export namespace tail {
                ...
                export type content<GAnnotation> = [ false ] | [ true, T.Value__Selection__Tail<GAnnotation>]
            ...
            export type tail<GAnnotation> = {
                readonly 'content': [ false ] | [ true, T.Value__Selection__Tail<GAnnotation>]
                readonly 'result': [ false ] | [ true, T.Type<GAnnotation>]
            }
        }

...
export namespace T {
    ...
    export type AlgorithmImplementation<GAnnotation> = {
    ...
    export namespace Implementation {
        ...
        export namespace implementations {
            ...
            export type D<GAnnotation> = T.AlgorithmImplementation<GAnnotation>
        }
        
        export type implementations<GAnnotation> = pt.Dictionary<T.AlgorithmImplementation<GAnnotation>>
    }
    
    export type Implementation<GAnnotation> = {
        readonly 'implementations': pt.Dictionary<T.AlgorithmImplementation<GAnnotation>>
    }

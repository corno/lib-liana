...
export namespace T {
    ...
    export namespace Implementation {
        ...
        export type implementations<GPAnnotation> = pt.Dictionary<T.AlgorithmImplementation<GPAnnotation>>
    }
    
    export type Implementation<GPAnnotation> = {
        readonly 'implementations': pt.Dictionary<T.AlgorithmImplementation<GPAnnotation>>
    }
